...
if __name__ == "__main__":
    ...
    scores_matrix = np.load("/home/work/changqing/Insight_Multimodal_Pytorch/workshop/multimodal_v01_cls301_0802_115046/res/test/scores_matrix.npy")
    labels_matrix = np.load("/home/work/changqing/Insight_Multimodal_Pytorch/workshop/multimodal_v01_cls301_0802_115046/res/test/labels_matrix.npy")
    # baidu: [TEST] Finish	Loss: 97.205975,	avg_acc1:65.73,	avg_acc2:76.88,	avg_acc3:82.96,	avg_acc5:88.82
    # Insight: [TEST] Finish                    avg_acc1:71.46,	avg_acc2:82.47,	avg_acc3:87.31,	avg_acc5:91.50
    topk_list = [1, 2, 3, 5]
    for top_k in topk_list:
        topk_hit = compute_topk_accuracy(scores_matrix, labels_matrix, top_k)
        print(f"hit@{top_k}: {topk_hit}")
